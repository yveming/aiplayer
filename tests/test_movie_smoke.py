...
class MockKodiAPI:
    TREE = {
        'nfs://media.example/Public/movie/': [
            # Flat files
            {'filetype': 'file', 'label': '独立日.mkv', 'file': 'nfs://media.example/Public/movie/独立日.mkv'},
            # Year dir (no genre)
            {'filetype': 'directory', 'label': '阿凡达 (2009)',
             'file': 'nfs://media.example/Public/movie/阿凡达 (2009)/'},
            # Genre + year
            {'filetype': 'directory', 'label': '科幻',
             'file': 'nfs://media.example/Public/movie/科幻/'},
            # Chinese named movie
            {'filetype': 'directory', 'label': '关于约会的一切',
             'file': 'nfs://media.example/Public/movie/关于约会的一切/'},
        ],
        'nfs://media.example/Public/movie/阿凡达 (2009)/': [
            {'filetype': 'file', 'label': 'Avatar.2009.2160p.BluRay.x264.mkv',
             'file': 'nfs://media.example/Public/movie/阿凡达 (2009)/Avatar.2009.2160p.BluRay.x264.mkv'},
            {'filetype': 'file', 'label': 'Avatar.2009.1080p.WEB-DL.mkv',
             'file': 'nfs://media.example/Public/movie/阿凡达 (2009)/Avatar.2009.1080p.WEB-DL.mkv'},
        ],
        'nfs://media.example/Public/movie/科幻/': [
            {'filetype': 'directory', 'label': '银翼杀手 2049 (2017)',
             'file': 'nfs://media.example/Public/movie/科幻/银翼杀手 2049 (2017)/'},
        ],
        'nfs://media.example/Public/movie/科幻/银翼杀手 2049 (2017)/': [
            {'filetype': 'file', 'label': 'Blade.Runner.2049.2017.2160p.UHD.BluRay.mkv',
             'file': 'nfs://media.example/Public/movie/科幻/银翼杀手 2049 (2017)/Blade.Runner.2049.2017.2160p.UHD.BluRay.mkv'},
        ],
        'nfs://media.example/Public/movie/关于约会的一切/': [
            {'filetype': 'file', 'label': '关于约会的一切.2023.1080p.WEB-DL.mkv',
             'file': 'nfs://media.example/Public/movie/关于约会的一切/关于约会的一切.2023.1080p.WEB-DL.mkv'},
        ],
    }
...
def run_test(name, query, expected_paths):
    ...
    api = MockKodiAPI()
    matches = search_remote_directory(api, 'nfs://media.example/Public/movie/', query, max_depth=10, debug=True)
...
if __name__ == '__main__':
    ...
    run_test('Flat file - "独立日"',
             '独立日',
             [
                 'nfs://media.example/Public/movie/独立日.mkv',
             ])
    ...
    run_test('Year dir - "阿凡达"',
             ...
             [
                 'nfs://media.example/Public/movie/阿凡达 (2009)/',
                 'nfs://media.example/Public/movie/阿凡达 (2009)/Avatar.2009.2160p.BluRay.x264.mkv',
                 'nfs://media.example/Public/movie/阿凡达 (2009)/Avatar.2009.1080p.WEB-DL.mkv',
             ])
    ...
    run_test('Genre + year - "银翼杀手"',
             ...
             [
                 'nfs://media.example/Public/movie/科幻/银翼杀手 2049 (2017)/',
                 'nfs://media.example/Public/movie/科幻/银翼杀手 2049 (2017)/Blade.Runner.2049.2017.2160p.UHD.BluRay.mkv',
             ])
    ...
    run_test('Long Chinese title - "关于约会的一切"',
             ...
             [
                 'nfs://media.example/Public/movie/关于约会的一切/',
                 'nfs://media.example/Public/movie/关于约会的一切/关于约会的一切.2023.1080p.WEB-DL.mkv',
             ])
